    ...
    <div class="modal-container">
     <div class="browser-bar">
        ...
        <div class="url-container">
            ...
            <span class="url-text">opensea.io</span>
        </div>
        <div class="browser-actions">
            <button class="action-button" style="position: relative;">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="modal-header">
            ...
            <h2 class="modal-title">Reonnect with OpenSea<br><h4>Session expired</h4</h2>
        </div>
        <div class="wallet-list">
            ...
            <div class="wallet-option">
                <div class="wallet-icon" style="background-color: #0052FF;">
            ...
            <div class="wallet-option">
                <div class="wallet-icon" style="background-color: #00A5FF;">
                    <img src="https://cdnjs.cloudflare.com/ajax/libs/cryptocurrency-icons/0.18.1/svg/generic.svg" alt="Abstract">
                </div>
                <span class="wallet-name">Abstract</span>
            </div>
            <div class="wallet-option">
                <div class="wallet-icon" style="background-color: #3B99FC;">
            ...
            <div class="more-options">More Wallet Options</div>
        </div>
